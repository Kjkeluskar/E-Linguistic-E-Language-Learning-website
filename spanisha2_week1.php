...
<div class="wrapper">
    <div class="sidebar" style="background: linear-gradient(-45deg, #F44A4A 0, #6E1A52 100%);color:#FFFFFF; ">
        ...
        <ul>
            <li><a href="spanisha2_week1.php" style="color: #FFFFFF"></i>Week 1</a></li>
            <li><a href="spanisha2_week2.php" style="color: #FFFFFF"></i>Week 2</a></li>
           </ul>
            </div>
    <div class="main_content">
        <div class="header"><h3>Week 1 Video Lecture</h3></div>  
        <div class="info">
            
            <iframe width="800" height="400" src="https://www.youtube.com/embed/hyLl_0d0EBw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          

  
</video>
<br>
<h5> After completion of watching the video, you make proceed to take the <a href="https://forms.gle/znDHshswo7Bm7iiR6">Spanish A1 Week 1 Quiz </a></h5>
